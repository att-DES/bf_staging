...
<?php
	...
	*/
	...
	// Form the URL to get deviceInfo
        $device_info_Url = "https://beta-api.att.com/1/devices/tel:+14255808673/info";
	...
	*/
        if($responseCode==200)
        {
	     ...
	     echo "<tr><td>acwdevcert</td><td>".$jsonObj->{'capabilities'}->{'acwav'}."</td></tr>";
	     echo "<tr><td>acwrel</td><td>".$jsonObj->{'capabilities'}->{'acwaocr'}."</td></tr>";
	     echo "<tr><td>acwmodel</td><td>".$jsonObj->{'capabilities'}->{'acwcf'}."</td></tr>";
	     print "</table>";
        }
        else{
