...
<?php
	...
	*/
	...
	$device_location_Url = "https://beta-api.att.com/1/devices/tel:+14255808673/location";
	...
	*/
	if($responseCode==200)
        {
		$jsonObj = json_decode($device_location_response,true);//decode the response and display it.
