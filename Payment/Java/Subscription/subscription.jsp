...
if(accessToken==null || accessToken=="null") {
	accessToken = "";
	session.setAttribute("postOauth", "subscription.jsp");
...
Cancel Redirect Url <input type="text" name="cancelUrl" value="http://ddprdm.net:8080/apigee-public/subscription.jsp" size=40/><br />
Fulfillment Url <input type="text" name="fulfillUrl" value="http://ddprdm.net:8080/apigee-public/subscription.jsp" size=40/><br />
...
Status Url <input type="text" name="statusUrl" value="http://ddprdm.net:8080/apigee-public/subscription.jsp" size=40/><br />
